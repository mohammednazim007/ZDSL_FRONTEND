...
//   const handlePricePerSQFTSliderChange = (e: React.ChangeEvent<HTMLInputElement>) => {
...
//                           onClick={() => handleProjectSelection(pr?._id, pr?.projectTitle)}
...
//                 } else {
//                   console.log('Button is disabled because selectedProject is empty.');
//                 }
//               }}
...
//                             key={unit.id}
//                             className="list-none py-2 ps-4 text-[#063354] hover:bg-[#fdf4df] hover:rounded duration-300 cursor-pointer hover:text-black"
//                             onClick={() => handleFlatSelection(unit.flatSize, unit.id)}
//                           >
//                             {unit.flatSize}
//                           </li>
//                         )
...
//         {installments > 5 ? <div className="border-2 border-[#FF2E905E] p-4 rounded mb-6">
//           <h1 className="text-[#000] text-xl font-semibold">
//             <span className="text-[#FF2E90] text-md">!</span>Alert
//           </h1>
//           <p className="mb-2 text-sm">
//             You have incurred a loss of <span className='font-bold text-[#FF7A85]'>5,000</span> BDT due to extended installments.
//             Consider reducing the number of installments to avail of a discount
//           </p>
//         </div> : ""}
...
//               <h3>
//                 Total Due: <span className="font-semibold text-md">{dueAmount}</span>{' '}
//                 BDT
//               </h3>
//               <p>Monthly Installment (BDT)</p>
//               <h1 className="font-bold text-xl">{monthlyInstallmentsInAmount}</h1>
//             </div>
//           </div>
//         </div>
//       </div>
