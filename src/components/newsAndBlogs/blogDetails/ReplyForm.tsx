...
"use client"
import { useAddReplyMutation } from "@/services/reply.service";
...
const ReplyForm = ({commentId, setIsModalOpen}: any) => {
        ...
        if (!hasErrors) {
            ...
            try {
                ...
                if (response?.data?.addReply) {
                    ...
                    toast.error('Failed to add reply: ' + response.createComment.message);
                }
            } catch (err) {
